...
const AccountHistory = ({ AccountsData }) => {
                    ...
                    {visible && foundedAccount.length > 0 && (
                        ...
                        {foundedAccount.map((account, index) => (
                            ...
                            {account.Transactions && account.Transactions.length > 0 ? (
                                ...
                                <p className="text-red-600 text-2xl px-4 font-bold mt-0 backdrop-blur-md mx-24 py-4 border-4 border-red-400 rounded-lg text-center mb-6">
