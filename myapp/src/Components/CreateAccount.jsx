...
const CreateAccount = () => {
    ...
    return (
        <>  
                <div class="flex flex-col items-center pt-2 pb-8 md:pt-14 min-h-screen bg-[#020d2] text-white md:px-0">
                    <h1 class="font-semibold text-3xl tracking-wide text-center mt-10 text-[#64ffda]">
                        Welcome New User
                    </h1>
                    <label className="relative top-10 w-full px-4 md:w-1/2 text-white">
                        <select
                            name="AccountType"
                            className="w-full px-4 py-2 border rounded-lg bg-[#0a192f] text-center text-white focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent hover:cursor-pointer tracking-wide font-bold uppercase text-lg"
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14 relative top-20 w-full px-6 md:px-10 md:w-1/2">
                        <input 
                            type="text"
                            className="text-xl px-2 py-2 border-b-2 bg-transparent focus:outline-none font-semibold focus:border-green-600 tracking-wider text-white placeholder-gray-400"
                        ...
                        <input 
                            type="text"
                            className="text-xl px-2 py-2 border-b-2 bg-transparent focus:outline-none font-semibold focus:border-green-600 tracking-wider text-white placeholder-gray-400 cursor-not-allowed"
                    ...
                    <button 
                        type="submit"
                        className="relative top-32 bg-green-500 md:w-1/6 px-6 h-12 text-xl cursor-pointer text-black font-semibold tracking-wider rounded-lg hover:bg-green-700 transition-all duration-100 transform"
                    ...
                    {visible && (
                        <button 
                            type="button"
                            className="relative left-1/3 bottom-6 bg-yellow-500 md:w-1/12 px-4 h-12 text-xl font-semibold text-black rounded-lg cursor-pointer tracking-widest hover:bg-yellow-700 transition-all duration-100 transform"
